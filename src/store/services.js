...
const testappAPI = axios.create({
  baseURL: "https://testapp-20761-prod.herokuapp.com/",
...
function rest_auth_password_change_create(requestBody) {
  return testappAPI.post(`/rest-auth/password/change/`, requestBody)
}
function rest_auth_password_reset_create(requestBody) {
  return testappAPI.post(`/rest-auth/password/reset/`, requestBody)
}
function rest_auth_password_reset_confirm_create(requestBody) {
  return testappAPI.post(`/rest-auth/password/reset/confirm/`, requestBody)
}
function rest_auth_registration_create(requestBody) {
  return testappAPI.post(`/rest-auth/registration/`, requestBody)
}
function rest_auth_registration_verify_email_create(requestBody) {
  return testappAPI.post(`/rest-auth/registration/verify-email/`, requestBody)
}
function rest_auth_user_read() {
  return testappAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(requestBody) {
  return testappAPI.put(`/rest-auth/user/`, requestBody)
}
function rest_auth_user_partial_update(requestBody) {
  return testappAPI.patch(`/rest-auth/user/`, requestBody)
}
